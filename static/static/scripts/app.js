...
function geocode(platform) {
  var geocoder = platform.getGeocodingService(),
    geocodingParameters = {
      searchText: 'Arya Samaj Road, Holi Gate, Mathura, Uttar Pradesh, India' ,
      jsonattributes : 1
    };
...
function getLocation(platform,place){
  geocodingParameters = {
    searchText : place,
    jsonattributes : 1
  };
...
getLocation(platform,place);

}
//show('Arya Samaj Road, Holi Gate, Mathura, Uttar Pradesh, India');
