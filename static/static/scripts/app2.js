 ...
 * Invalidenstra�e 116, 10115 Berlin.
 *
 *
 ...
 */
function reverseGeocode(platform,place) {
...
var platform = new H.service.Platform({
  app_id: 'v6rMdIBZi0xBhTHXEuym',
  app_code: 'VrF82ePI6dI6Pw92aiuINQ',
  useCIT: true,
  useHTTPS: true
});
        ...
        address = locations[i].location.address,
         ...
         position = {
           ...
           lng: locations[i].location.displayPosition.longitude
            ...
            var add = address.street+', ' + address.district+', ' + address.city+ ', ' + address.postalCode+ ', ' + address.country;
        $('#address').val(add);
...
function getCode(place){
reverseGeocode(platform,place);
}